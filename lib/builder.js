...
function BuilderClass(options) {
    ...
    this.loaderTemplatePath = options.loaderTemplatePath;
    this.data = {
        json: {},
        conds: {},
        files: null,
...
BuilderClass.prototype = {
    ...
    header: function () {
        var group = this.group,
            ...
            str = [],
            template;
        if (this.loaderTemplatePath && libfs.existsSync(this.loaderTemplatePath)) {
            template = libfs.readFileSync(this.loaderTemplatePath, 'utf8') + "";
            template = template.replace('@@GROUP@@', group);
            template = template.replace('@@MODULES@@', jsonStr);
            str.push(template);
        } else {
            str.join([
            '/* This file is auto-generated by locator plugin locator-yui for bundle ' + group + ' */',
            '',
            ...
            str.push('Y.mix(YUI.Env[Y.version].modules,  ' + jsonStr + ' );');
